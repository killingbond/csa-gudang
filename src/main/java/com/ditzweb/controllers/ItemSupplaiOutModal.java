...
public class ItemSupplaiOutModal {
	...
	@Init
	public void showData(@ExecutionArgParam("data") ItemSupplaiOut obj, @ExecutionArgParam("key") ItemSupplaiOut keys) {
		if (keys != null) {
	...
	public void add() {
		...
		itemSupplaiOut.setQty(jmlQty);
		itemSupplaiOut.setJumlah(this.jmlSatuanDasar);
		Map<String, Object> dt = new HashMap<String, Object>();
		dt.put("obj", itemSupplaiOut);
		BindUtils.postGlobalCommand(null, null, "addItemsSupplaiOut", dt);
	}
	...
	public void update() {
		...
		BindUtils.postGlobalCommand(null, null, "updateItemSupplaiOut", dt);
	}
