...
public class ItemSupplaiInUpdateModal {
	...
	public void add() {
		...
		BindUtils.postGlobalCommand(null, null, "addUpdateItemsSupplaiIn", dt);
	}
	...
	public void update() {
		...
		dt.put("obj", itemSupplaiIn);
		dt.put("obj2", this.key);
		BindUtils.postGlobalCommand(null, null, "updateupdateItemSupplaiIn", dt);
	}
