...
public class ItemSupplaiOutUpdateHargaModal {
	...
	public void add() {
		...
		itemSupplaiOut.setHargaSatuanDasar(this.hargaSatuanDasar);
		itemSupplaiOut.setHargaSatuanInput(this.hargaSatuanInput);
		itemSupplaiOut.setHargaTotal(this.hargaTotal);
	}
