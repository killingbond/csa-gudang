...
public class ItemSupplaiOut {
	...
	@ManyToOne
	private TransaksiOut transOut;
	
	public ItemSupplaiOut() {}

	public ItemSupplaiOut(int id, Items item, ItemsQuantity satuan, ItemsBasicUnit satuanDasar, int qty, Double jumlah,
